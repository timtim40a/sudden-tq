## Sudden TQ - Турнікет Зненацька

<strong>EN</strong> - English

Once on the [website](https://sudden-tq.vercel.app/), choose the timespan. 
A random number generator will define a moment within given timespan, which is hidden. 
Once the time is up, the body part needing tending will light up.
...
Перейдіть за посиланням на [сайт](https://sudden-tq.vercel.app/), та оберіть проміжок часу.
Генератор випадкових чисел визначить момент коли час спливе. Користувач не бачитиме коли саме це станеться.
